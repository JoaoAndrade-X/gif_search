...
class _HomePageState extends State<HomePage> {
  ...
  Future<Map> _getGifs() async {
    ...
    if (_search == null)
      ...
      response = await http.get(
          "https://api.giphy.com/v1/gifs/search?api_key=2PcuVWw0nYYP2Y8qiLmOug4aqu4xPUYH&q=$_search&limit=19&offset=$_offset&rating=g&lang=en&bundle=messaging_non_clips");
